...
const Navbar = ({setSideNavbarFunc,sideNavbar}) => {
  ...
  const getLogoutFun = async()=>{
    axios.post("https://youtube-app-xd3b.onrender.com/auth/logout",{},{ withCredentials: true}).then((res)=>{
      console.log("Logout ")
    }).catch(err=>{
      console.log(err)
    })
  ...
  return (
    <div className='navbar'>
      ...
      <div className='navbar-middle'>
        <div className='navbar_mike'><KeyboardVoiceIcon sx={{fontSize:"28px",color:"white"}}></KeyboardVoiceIcon> </div>
             
               <div className='navbar_searchbox'>
                
                 <input type='text' placeholder='Search' className='navbar_searchboxinput'></input>
